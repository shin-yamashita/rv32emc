...
int  main()
{
    ...
    printf("logsf err:%6.3fe-6 logf err:%6.3fe-6\n",fu((float)em1*1e6f), fu((float)em2*1e6f));
    printf(" cycle log:%5.1f logsf:%5.1f logf:%5.2f\n", fu((float)e0/n), fu((float)e1/n), fu((float)e2/n));
    ...
    printf("expsf err:%6.3fe-6 expf err:%6.3fe-6\n",fu((float)em1*1e6f), fu((float)em2*1e6f));
    printf(" cycle exp:%5.1f expsf:%5.1f expf:%5.2f\n", fu((float)e0/n), fu((float)e1/n), fu((float)e2/n));
    ...
    printf("powsf err:%6.3fe-6 powf err:%6.3fe-6\n",fu((float)em1*1e6f), fu((float)em2*1e6f));
    printf(" cycle pow:%5.1f powsf:%5.1f powf:%5.2f\n", fu((float)e0/n), fu((float)e1/n), fu((float)e2/n));
    ...
    printf("sinsf err:%6.3fe-6 sinf err:%6.3fe-6\n",fu((float)em1*1e6f), fu((float)em2*1e6f));
    printf(" cycle sin:%5.1f sinsf:%5.1f sinf:%5.2f\n", fu((float)e0/n), fu((float)e1/n), fu((float)e2/n));
    ...
    printf("cossf err:%6.3fe-6 cosf err:%6.3fe-6\n",fu((float)em1*1e6f), fu((float)em2*1e6f));
    printf(" cycle cos:%5.1f cossf:%5.1f cosf:%5.2f\n", fu((float)e0/n), fu((float)e1/n), fu((float)e2/n));

    em1 = em2 = 0.0;
    n = 0;
    e0 = e1 = e2 = 0;
    for(x = 0.0001; x < 2.0; x += 0.01){
        t0 = clock();
        yr = sqrt((double)x);
        t1 = clock();
        y1 = sqrtsf(x);
    ...
    printf("sqrtsf err:%6.3fe-6 sqrtf err:%6.3fe-6\n",fu((float)em1*1e6f), fu((float)em2*1e6f));
    printf(" cycle sqrt:%5.1f sqrtsf:%5.1f sqrtf:%5.2f\n", fu((float)e0/n), fu((float)e1/n), fu((float)e2/n));
