...
create_generated_clock -name clk100 -source [get_pins u_clk_gen/inst/plle2_adv_inst/CLKIN1] -master_clock [get_clocks clk] [get_pins u_clk_gen/inst/plle2_adv_inst/CLKOUT3]; # 100MHz
create_generated_clock -name clk300 -source [get_pins u_clk_gen/inst/plle2_adv_inst/CLKIN1] -master_clock [get_clocks clk] [get_pins u_clk_gen/inst/plle2_adv_inst/CLKOUT4]; # 300MHz
create_generated_clock -name clk200 -source [get_pins u_clk_gen/inst/plle2_adv_inst/CLKIN1] -master_clock [get_clocks clk] [get_pins u_clk_gen/inst/plle2_adv_inst/CLKOUT5]; # 200MHz

#set_false_path -from [get_clocks clk100]     -to [get_clocks cclk]
